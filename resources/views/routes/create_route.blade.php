	...
	<body bgcolor="#D0D0D0" onload="initialize()">
	  ...
	  <div id="control_panel" 
	    ...
	    <table border="0" cellpadding="4" cellspacing="0">
	      <tr>
      		<td style="font-size:small;">　Info_Window　経路検索後は経路の <span id="orderCoord" style="color:blue">Lat-Lng</span> 順　
			 （<input type="checkbox" id="orderLngLat" class="black">Lng,Lat 順）
	      	</td>
	      </tr>
	      <tr>
	      	<td>　　
    	...
    	<div id="directionsPanel" style="margin:3px; font-size:small; width:340px; height:320px; overflow:scroll;">
      		<div style="font-size:mideum;">Total Distance: <span id="total" style="font-size:small;"></span></div>
	    </div>
	  </div>
